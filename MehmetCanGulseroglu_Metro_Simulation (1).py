...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        ziyaret_edildi = set()
        ziyaret_edildi.add((baslangic, baslangic.hat))

        while kuyruk:
            mevcut, yol, mevcut_hat = kuyruk.popleft()
            if mevcut == hedef:
                return yol
            ...
            for komsu, _ in mevcut.komsular:
                ...
                if yeni_hat == mevcut_hat:
                    if (komsu, yeni_hat) not in ziyaret_edildi:
                        ziyaret_edildi.add((komsu, yeni_hat))
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        while pq:
            ...
            for komsu, sure in mevcut.komsular:
                ...
                if komsu not in ziyaret_edildi or yeni_toplam_sure < ziyaret_edildi[komsu]:
                    ziyaret_edildi[komsu] = yeni_toplam_sure
